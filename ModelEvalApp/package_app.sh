...
if [[ -f "${REPO_ROOT}/PromptGradeApp/Defaults/Model_Testing_Rubric.xlsx" ]]; then
  mkdir -p "${APP_DIR}/Contents/Resources/Defaults"
  cp "${REPO_ROOT}/PromptGradeApp/Defaults/Model_Testing_Rubric.xlsx" \
    "${APP_DIR}/Contents/Resources/Defaults/Model_Testing_Rubric.xlsx"
fi
